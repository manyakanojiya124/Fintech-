...
export function DashboardTopbar({ onMenu }: { onMenu: () => void }) {
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-line bg-white/90 px-4 shadow-[0_1px_0_rgba(17,24,39,0.02)] backdrop-blur-md sm:px-6">
      <button
        onClick={onMenu}
